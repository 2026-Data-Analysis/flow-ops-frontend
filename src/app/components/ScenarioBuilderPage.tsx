...
const normalizeScenarioDetail = (scenario: ScenarioDetailResponse, lastExecutedAt?: string): ScenarioTemplate => ({
  ...
  reasonType: 'coverage',
  testLevel: scenario.testLevel ?? undefined,
  estimatedRisk: scenario.estimatedRisk ?? undefined,
...
const normalizeAiScenario = (
  ...
  return {
    ...
    testLevel: scenario.test_level ?? scenario.meta?.test_level ?? undefined,
    estimatedRisk: scenario.meta?.estimated_risk ?? undefined,
    steps,
  };
};
                  ...
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-center">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        {scenario.testLevel && (
                          <span className="text-xs px-2 py-0.5 rounded bg-blue-500/10 text-blue-400 border border-blue-500/20 uppercase">
                            {scenario.testLevel}
                          </span>
                        )}
