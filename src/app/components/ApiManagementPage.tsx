...
export function ApiManagementPage() {
  ...
  return (
    <div className="api-management-shell responsive-detail-grid relative flex-1 overflow-hidden bg-[#060609] grid" style={{ gridTemplateColumns: '1fr' }}>
      ...
      {/* API List Panel */}
      <div className="px-4 pb-4 pt-3 sm:px-6 sm:pb-6 lg:px-8 lg:pb-8">
        <div className="overflow-hidden rounded-xl border border-[#1f1f28] bg-[#0d0d12]">
          <div className="flex items-center justify-between border-b border-[#1f1f28] px-4 py-2.5">
